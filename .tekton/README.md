...
To modify the pipelines for `guardrails-detectors` in the `rhoai-3.5-ea.2` release:
...
```bash
git commit -am "Update pipelinerun for guardrails-detectors (rhoai-3.5-ea.2)"
