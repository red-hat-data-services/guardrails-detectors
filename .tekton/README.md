...
To modify the pipelines for `guardrails-detectors` in the `rhoai-3.6-ea.1` release:
...
```bash
git commit -am "Update pipelinerun for guardrails-detectors (rhoai-3.6-ea.1)"
